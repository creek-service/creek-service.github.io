...
Certainly, in a well-engineered system, such a change would be avoided as it wouldn't be an evolvable change.
...
Then you have a challenge, potentially involving getting everyone to update at the same time.
